...
public class MusicService extends MediaBrowserServiceCompat {
    ...
    private static final String TAG = "Log " + MusicService.class.getSimpleName();
    ...
    public class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onPrepare() {
            if (mQueueIndex < 0 && mPlaylist.isEmpty()) {
                Log.d(TAG, "onPrepare: Nothing to play");
                // Nothing to play.
                return;
            }
            Log.d(TAG, "onPrepare: MediaSessionCallback ");
            final String mediaId = mPlaylist.get(mQueueIndex).getDescription().getMediaId();
            Log.d(TAG, "onPrepare: mQueueIndex size is : " + mQueueIndex + " mPlaylist size is : " + mPlaylist.size());
            Log.d(TAG, "onPrepare: mediaID - " + mediaId);
            mPreparedMedia = MusicLibrary.getMetadata(MusicService.this, mediaId);
            Log.d(TAG, "onPrepare: mPreparedMedia : " + mPreparedMedia.getDescription());
