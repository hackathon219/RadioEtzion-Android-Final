...
public final class MediaPlayerAdapter extends PlayerAdapter {
    ...
    private static final String TAG = "Log " + MediaPlayerAdapter.class.getSimpleName();

    Intent podcastDuration = new Intent("podcastDuration");
...
//        playFile(MusicLibrary.getMusicFilename(mediaId));
        String uri = MusicLibrary.getMusicUri(mediaId);
        Log.d(TAG, "playFromMedia: " + uri);

        playFileFromUri(mediaId, mediaUri);
    ...
    public void playFileFromUri(String filename, Uri uri) {
        Log.d(TAG, "playFileFromUri: ");
        ...
        try {
            ...
            Log.d(TAG, "playFileFromUri: enter to Exception first " + e);
        ...
        try {
            ...
            Log.d(TAG, "playFileFromUri: enter to Exception second " + e);
            throw new RuntimeException("Failed to open file: " , e);
        }
        ...
        mMediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                podcastDuration.putExtra("duration", mp.getDuration());
                mContext.sendBroadcast(podcastDuration);
    ...
    private MediaMetadataCompat  reBuiledMediaItem(MediaMetadataCompat mCurrentMedia, Long duration){
        String uri = mCurrentMedia.getString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI);
        String id = mCurrentMedia.getString(MediaMetadataCompat.METADATA_KEY_MEDIA_ID);
        String title = mCurrentMedia.getString(MediaMetadataCompat.METADATA_KEY_TITLE);
