 ...
 */
public class MediaBrowserHelper implements Serializable {

    private static final String TAG = "Log " + MediaBrowserHelper.class.getSimpleName();
    ...
    public void onStart() {
        if (mMediaBrowser == null) {
            ...
            Log.d(TAG, "onStart: mMediaBrowser null - Creating MediaBrowser, and connecting");

        }else {
            Log.d(TAG, "onStart: Creating MediaBrowser, and connecting - mMediaBrowser not null");
