...
public class TokensPersistenceManager {
    ...
    private static final String APPID_DEVICE_ID = "appid_device_id";
    private static final String APPID_IS_ANONYMOUS = "appid_is_anonymous";
    private static final String APPID_IS_REGISTER_TO_NOTIFICATION = "appid_is_notification_registered";
    ...
    public void persistTokensOnDevice(){
        ...
        sharedPreferences.edit().
                ...
                putString(APPID_DEVICE_ID, identityToken.getOAuthClient().getDeviceId()).
    ...
    public void saveKeyFromFB(String key){
        SharedPreferences sharedPreferences = ctx.getSharedPreferences(APPID_TOKENS_PREF, ctx.MODE_PRIVATE);
    ...
    public void saveNotificationStatus(){
        SharedPreferences sharedPreferences = ctx.getSharedPreferences(APPID_TOKENS_PREF, ctx.MODE_PRIVATE);
        sharedPreferences.edit().putBoolean(APPID_IS_REGISTER_TO_NOTIFICATION, true).apply();
    }

    public boolean isRegisterToNotification(){
        SharedPreferences sharedPreferences = ctx.getSharedPreferences(APPID_TOKENS_PREF, ctx.MODE_PRIVATE);
        return sharedPreferences.getBoolean(APPID_IS_REGISTER_TO_NOTIFICATION, false);
    }
    ...
    public String getStoredDeviceID(){
        SharedPreferences sharedPreferences = ctx.getSharedPreferences(APPID_TOKENS_PREF, ctx.MODE_PRIVATE);
        return sharedPreferences.getString(APPID_DEVICE_ID, null);
    }
